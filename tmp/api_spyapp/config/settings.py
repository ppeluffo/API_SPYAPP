...
#
PGSQL_HOST_COMMS = os.getenv( "PGSQL_HOST_COMMS", "192.168.0.8")
PGSQL_PORT_COMMS = os.getenv( "PGSQL_PORT_COMMS", "5432")
PGSQL_USER_COMMS = os.getenv( "PGSQL_USER_COMMS", "admin")
PGSQL_PASSWD_COMMS = os.getenv( "PGSQL_PASSWD_COMMS", "pexco599")
PGSQL_BD_COMMS = os.getenv( "PGSQL_BD_COMMS", "bd_spcomms")
#
...
URL_COMMS = f"postgresql+psycopg2://{PGSQL_USER_COMMS}:{PGSQL_PASSWD_COMMS}@{PGSQL_HOST_COMMS}:{PGSQL_PORT_COMMS}/{PGSQL_BD_COMMS}"
